...
<div class="head-dot"></div>
    ...
    <div id="menucontrol-left">
        ...
        <div class="menu"> 
            ...
            <center><ul>
                ...
                <li><a href="categories.php" >&nbsp CATEGORIES &nbsp</a></li>
                <li><a href="news.php" class="active">&nbsp NEWS &nbsp</a></li>
                <li><a href="contact.php">&nbsp CONTACT &nbsp</a></li>
                <li><a href="uploads.php">&nbsp UPLOADS &nbsp</a></li>
            </ul></center>
        </div>
  ...
  <!-- END HEAD -->
    ...
    <div class="wrap-content">
    	...
    	<div id="box-pic">
    		<img src="<?php  echo $rows['newsPicture']; ?>">
    	...
    	<div id="box-content">
    		...
    		<p><?php  echo $rows['newsContent']; ?></p> <br>

        <p><?php  echo $rows['newsCredit']; ?></p>

<?php session_start();
    ...
    if ($_SESSION['memberType']!='designer') {
      header("location:uploads_fail.php");
    }
  ?>
...
<head>
	<meta charset="UTF-8">
	<link rel="stylesheet" type="text/css" href="css/uploads_style.css">
...
<div class="head-dot"></div>
    ...
    <div id="menucontrol-left">
      ...
      ?>
        ...
        <center>
        <br>
        <div class="title"><p4>Uploads</p4></div>
        <br>
    ...
    <form action="uploads_db.php" method="POST" enctype="multipart/form-data">

        	Picture Work : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="file" name="imgFile_f" id="imgFile_f" class="file">
		<br>

        	Name Work : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="namework">
		<br>
		Type of Work : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="typework">
		...
		<br>
		Price (bath) : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="price">
		<br>
		...
		<button class="submit" type="submit" value="Log in" name="Log in">Uploads
		</button> <br><br>

    </form>


		<p1><a href="home.php">Cancle</a></p1>

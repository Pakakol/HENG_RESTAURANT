...
<head>
	...
	<meta charset="UTF-8">
	<link rel="stylesheet" type="text/css" href="css/work_details_style.css">
...
<div class="head-dot"></div>
  ...
  <!-- END HEAD -->
    ...
    <div class="wrap-content">
        ...
        $uploadsId=$_GET['uploadsId'];

        require './connect.php'; 

          $sql="SELECT * FROM Uploads WHERE uploadsId='$uploadsId';";
    	...
    	<div id="box-pic">
    		<img src="<?php  echo $rows['pictureWork']; ?>">
      ...
      <?php 
        ...
        $memberIdUploads = $rows['memberId'];

        $sql2="SELECT * FROM Member WHERE memberId='$memberIdUploads';";
      ...
      <a href="profile.php?memberId=<?php echo $memberIdUploads ?>"><img src="<?php  echo $rows2['memberProfilePicture']; ?>"> </a>

      <?php }// end while picture ?>
